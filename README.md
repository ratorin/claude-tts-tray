...
| 音声（読み上げ） | 返答読み上げ(Stop)用。効果音(完了音/チャイム/なし) または 話者(人 ▸ 種類) を選ぶ2段メニュー |
| 音声（確認） | 確認通知用。効果音(チャイム/なし) または 話者(人 ▸ 種類) を選ぶ2段メニュー |
...
- **右クリック** … メニュー表示
- アイコン: Claude風スターバースト＋音波の意匠。**橙=有効** / **灰(ミュート斜線)=無効** / **橙+停止■=発話中**。
...
- **`read_mode`** … 読み上げ(Stop): voice=読み上げ / done=完了音 / chime=チャイム / none=無音。
- **`notify_mode`** … 確認: speak=発話 / chime=チャイム / none=無音。

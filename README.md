...
│   ├── autostart-setup.cmd, autostart-remove.cmd
...
- 有効化: `scripts/autostart-setup.cmd` をダブルクリック（**VOICEVOXエンジン**＋**トレイ**の両方をHKCU Runに登録し、その場で起動）
- 解除: `scripts/autostart-remove.cmd` をダブルクリック（両方を解除）
